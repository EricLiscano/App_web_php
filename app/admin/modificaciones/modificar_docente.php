...
<body>
    ...
    <div class="container">
        ...
        <table id="data_table" class="table table-striped">
            ...
            <tbody>
                <?php
        $sql_query = "SELECT id,nombre,apellido,  fechanac, documento, pais, telefono,direccion FROM Docente LIMIT 100";
    ...
    <script type="text/javascript" src="./js/custom_table_edit_docente.js"></script>
</body>
