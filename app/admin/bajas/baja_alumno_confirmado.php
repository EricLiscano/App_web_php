<?php
/* Obtengo los datos enviados por POST y elimino al alumno y su perfil de base de datos. */
...
$eliminarAlumno = "DELETE  FROM Alumno where id_perfil=$id_perfil";
$eliminarPerfil = "DELETE  FROM perfil where id=$id_perfil";

$eliminarSql= mysqli_query($link, $eliminarAlumno);
...
if($eliminarSql){
    ...
    echo "ERROR: ". $eliminarAlumno . " revisar sintax";
}
?>
